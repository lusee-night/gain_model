...
def decode_packets(filepath):
    ...
    Steps:
      1) Read NUM_PACKETS packets of PACKET_SIZE bytes.
...
if __name__ == "__main__":
    cpt_list_path = Path("~/gain_model/scripts/CPT_directories_withCPT1.txt").expanduser()
    out_list_path = Path("~/gain_model/scripts/DCB_directories_withCPT1.txt").expanduser()
